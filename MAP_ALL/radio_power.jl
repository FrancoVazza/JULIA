@everywhere function radio(d::Float64,t::Float64,m::Float64,bx::Float64,by::Float64,bz::Float64,nu::Float64,pradio::Float64)
 const  xsi=1e-4
 ...
 const   logs=(res/(1.+z))^2.  #...pysical surface of shocked cell 
   ...
   sradio=(s-1.)*0.5 +0.5 
    pradio=6.4e34*logs*(d/(mp*1e-4))*xsi/(5e-2)*(t/(7.*1.16e7))^1.5*(nu/(1.4))^(-sradio)
...
@everywhere function fpradio(d::Float64,t::Float64,mach::Float64,bx::Float64,by::Float64,bz::Float64,nu::Float64,pradio::Float64) 
   ...
   sradio=(s-1.)*0.5 +0.5 
   pradio=6.4e34*logs*(d*mw_pm/(1e-4))*xsi/(5e-2)*(t/(7.*1.16e7))^1.5*(nu/(1.4))^(-sradio)
   pradio=pradio*bf^(1.+sradio)/(3.2^2.+bf^2.)
   println(pradio)
